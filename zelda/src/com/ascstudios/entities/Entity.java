...
public class Entity {
	...
	public static BufferedImage ENEMY_EN = Game.spritesheet.getSprite(16, 16, 16, 16);
	public static BufferedImage ENEMY_EN2 = Game.spritesheet.getSprite(0, 16, 16, 16);
